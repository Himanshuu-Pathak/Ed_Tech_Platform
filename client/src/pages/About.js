...
import StatsComponents from "../Component/Core/AboutPage/Stats"
    ...
    <div>
        ...
        <section className="bg-slate-700">
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                ...
                <p className="mx-auto mt-3 text-center text-base font-medium text-slate-400 lg:w-[95%]">
        ...
        <section className="border-b border-slate-700 bg-slate-950">
            ...
            <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-slate-500">
                <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
                    ...
                    <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                        <h1 className="bg-gradient-to-b from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] "> 
                            Our Founding Story
                        </h1>
