  ...
  return (
    <div>
      <div className='flex flex-col md:flex-row md:justify-between md:items-center mb-14 gap-y-5' >
        <h1 className='text-3xl font-medium text-slate-50 lg:text-left text-center uppercase tracking-wider' >My Courses</h1>
      ...
      <div >
        {
          loading ?
            ...
            !courses || courses.length === 0 ?
              (
                <div>
                  <div className='h-[1px] mb-10  mx-auto bg-slate-500' ></div>
                  <p className='text-center text-2xl font-medium text-slate-100 select-none' >No Courses Found</p>
                </div>
              )
              :
