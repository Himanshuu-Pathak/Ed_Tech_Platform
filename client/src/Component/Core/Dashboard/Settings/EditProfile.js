  ...
  return (
    <div>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        <div className='my-5 rounded-md border border-slate-700 bg-richblack-800 py-8 px-5 md:px-12'>
          <h1 className='text-lg mb-6 font-semibold text-slate-50 uppercase tracking-wider'>Profile Information</h1>
                ...
                >

                  {
                    genders.map((gender, ind) => (
                      <option className='text-slate-50' key={ind} value={gender} > {gender} </option>
                    ))
                  }
                </select>
              </label>
        ...
        <div className='flex justify-end gap-2'>
          <button onClick={() => navigate('/dashboard/my-profile')} className={`rounded-md bg-slate-700 lg:py-2 py-1 lg:px-5 px-2 font-semibold text-slate-50 uppercase tracking-wider 
