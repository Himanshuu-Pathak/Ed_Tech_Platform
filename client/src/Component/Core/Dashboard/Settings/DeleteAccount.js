    ...
    <div className=' mt-7 rounded-md border border-pink-700 bg-pink-900 p-8 px-5 md:px-12' >
      <div className='flex gap-x-5 ' >
        ...
        <div className='flex flex-col space-y-2 ' >
          <h2 className='text-lg font-semibold text-slate-50 uppercase tracking-wider'>Delete Account</h2>
          <div className='lg:w-full text-pink-50 space-y-1 lg:text-lg text-md tracking-wider' >
