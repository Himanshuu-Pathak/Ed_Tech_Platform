  ...
  return (
    <div>
      <form onSubmit={handleSubmit(submitPasswordForm)}>
        <div className='my-5 rounded-md border border-slate-700 bg-richblack-800 p-8 px-12'>
          <h1 className='text-lg mb-6 font-semibold text-slate-50 uppercase tracking-wider' >Password</h1>
