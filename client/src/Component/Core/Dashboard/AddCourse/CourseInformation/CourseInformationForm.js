...
export default function CourseInformationForm() {
  ...
  return (
    <form
      ...
      className="space-y-8 rounded-md border-[1px] border-slate-700 bg-richblack-800 p-6"
    >
      {/* Course Title */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-slate-50 uppercase tracking-wider" htmlFor="courseTitle">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-slate-50 uppercase tracking-wider" htmlFor="courseShortDesc">
      ...
      {/* Course Price */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-slate-5 uppercase tracking-wider" htmlFor="coursePrice">
      ...
      {/* Course Category */}
       <div className="flex flex-col space-y-2">
        <label className="text-sm text-slate-50 uppercase tracking-wider" htmlFor="courseCategory">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-slate-50 uppercase tracking-wider" htmlFor="courseBenefits">
